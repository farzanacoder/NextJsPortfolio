    ...
    <section className='mb-16'>
     <div className='relative container flex items-center justify-center text-white overflow-hidden flex-col pt-28'>
        ...
        <div className="relative z-10 flex flex-col items-center" >
            <Image data-aos='fade-up' alt='hero' src={Hero} className='rounded-full h-[150px] w-[150px] border-8 border-[#0c0c48aa]'/>
            ...
            <button data-aos='fade-up' data-aos-delay='600' className='mt-6 px-10 py-4 bg-[#0C1E5D] hover:bg-blue-900 transition-all duration-500 cursor-pointer rounded-full text-lg font-medium'>
